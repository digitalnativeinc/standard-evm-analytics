          ...
          <Paper variant="outlined" className={classes.paper}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="subtitle2" color="textSecondary" noWrap>
                {pair.token0.symbol}{" "}
                {`- ${formatCurrency(
                  pair.token0?.derivedETH * bundles[0].price
                )}`}
              </Typography>
            </Box>
          ...
          <Paper variant="outlined" className={classes.paper}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="subtitle2" color="textSecondary" noWrap>
                {pair.token1.symbol}{" "}
                {`-  ${formatCurrency(
                  pair.token1?.derivedETH * bundles[0].price
                )}`}
              </Typography>
            </Box>
            <Typography variant="body2">
        ...
        <Grid item xs={12} sm={6} md={4}>
          <KPI
            ...
            value={formatCurrency(
              parseFloat(pair.reserveETH) * bundles[0].price
            )}
          />
        </Grid>
        <Grid item xs={12} sm={6} md={4}>
          <KPI title="Tx (24h)" value={tx} format="integer" />
        </Grid>
      </Grid>
